...
namespace eh
{
  ...
  struct exception_descriptor
  {
    ...
    dtor_ft                  dtor;                // exception destructor
  ...
  struct catch_descriptor
  {
    ...
    catch_handler_ft    handler_address;    // address of the catch handler code, returns address where to continues execution (i.e. code after the try block)
  };
