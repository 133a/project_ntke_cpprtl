...
namespace
{
  ...
  {
    EH_OK                 = 0
  , UNEXPECTED_CATCH1     = 1001
  , UNEXPECTED_CATCH2     = 1002
  , UNEXPECTED_CATCH3     = 1003
  , UNEXPECTED_CATCH4     = 1004
  , UNEXPECTED_CATCH5     = 1005
  , UNEXPECTED_CATCH6     = 1006
  , SPECIAL_EXCEPTION100  = 1010
  , MAGIC_DTOR100         = 1011
  };
