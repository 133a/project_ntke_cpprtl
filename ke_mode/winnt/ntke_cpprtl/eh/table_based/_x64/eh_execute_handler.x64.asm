...
EHret:
    ...
    LEAF_END _CPPRTL_execute_frame_handler_handler, _TEXT
    ...
    NESTED_ENTRY _CPPRTL_execute_frame_handler, _TEXT, _CPPRTL_execute_frame_handler_handler
...
EHexecute:                                                                  ; all the params for handler invoking are already in registers, so just
    ...
    NESTED_END _CPPRTL_execute_frame_handler, _TEXT
