...
////////////////////////////////////////////////////////////
////
////  cl internally pre-declared RTTI routines' entry points
////
////////////////////////////////////////////////////////////

extern "C"
void* __cdecl __RTDynamicCast(void* src_obj, long vfdelta, void* src_type, void* dst_type, int is_ref)
throw (...)
{
...
extern "C"
void* __cdecl __RTtypeid(void* src_obj)
throw (...)
{
...
extern "C"
void* __cdecl __RTCastToVoid(void* src_obj)
throw (...)
{
