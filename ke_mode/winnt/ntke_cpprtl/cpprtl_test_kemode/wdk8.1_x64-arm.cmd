...
@echo on
"%GNU_MAKE_EXE%"  target.toolset=wdk8.1_x64-arm  target.profile=cpprtl_debug    target.kernel=nt6.3
"%GNU_MAKE_EXE%"  target.toolset=wdk8.1_x64-arm  target.profile=cpprtl_release  target.kernel=nt6.3
@echo off
