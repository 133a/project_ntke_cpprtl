...
set "PATH=%INTELCL13.0_FOLDER%\bin\ia32_intel64;%WDK710_FOLDER%\bin\x86\amd64;%PATH%"

@echo on
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk7.1.0_x86-x64 target.profile=debug target.kernel=nt6.1
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk7.1.0_x86-x64 target.profile=release target.kernel=nt6.1
@echo off
