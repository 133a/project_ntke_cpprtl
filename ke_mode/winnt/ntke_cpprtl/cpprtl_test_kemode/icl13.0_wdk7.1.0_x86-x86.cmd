...
set "PATH=%INTELCL13.0_FOLDER%\bin\ia32;%WDK710_FOLDER%\bin\x86;%WDK710_FOLDER%\bin\x86\x86;%PATH%"

@echo on
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk7.1.0_x86-x86 target.profile=debug target.kernel=nt6.1
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk7.1.0_x86-x86 target.profile=release target.kernel=nt6.1
@echo off
