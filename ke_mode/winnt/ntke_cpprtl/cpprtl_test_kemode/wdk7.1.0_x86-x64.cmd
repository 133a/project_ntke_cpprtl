...
@echo on
"%GNU_MAKE_EXE%" target.toolset=wdk7.1.0_x86-x64 target.profile=debug target.kernel=nt6.1
"%GNU_MAKE_EXE%" target.toolset=wdk7.1.0_x86-x64 target.profile=release target.kernel=nt6.1
@echo off
