...
set "PATH=%MSVS2015_FOLDER%\VC\bin\amd64;%PATH%"


@echo on
"%GNU_MAKE_EXE%"  target.toolset=wdk10_x64-x64  target.profile=cpprtl_debug    target.kernel=nt10.0
"%GNU_MAKE_EXE%"  target.toolset=wdk10_x64-x64  target.profile=cpprtl_release  target.kernel=nt10.0
@echo off
