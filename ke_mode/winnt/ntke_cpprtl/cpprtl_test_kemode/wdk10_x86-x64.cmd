...
@echo on
"%GNU_MAKE_EXE%" target.toolset=wdk10_x86-x64 target.profile=debug target.kernel=nt10.0
"%GNU_MAKE_EXE%" target.toolset=wdk10_x86-x64 target.profile=release target.kernel=nt10.0
@echo off
