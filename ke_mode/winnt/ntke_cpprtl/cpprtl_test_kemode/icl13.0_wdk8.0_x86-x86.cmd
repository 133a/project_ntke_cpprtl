...
set "PATH=%INTELCL13.0_FOLDER%\bin\ia32;%MSVS2012_FOLDER%\VC\bin;%MSVS2012_FOLDER%\Common7\IDE;%PATH%"

@echo on
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk8.0_x86-x86 target.profile=debug target.kernel=nt6.2
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk8.0_x86-x86 target.profile=release target.kernel=nt6.2
@echo off
