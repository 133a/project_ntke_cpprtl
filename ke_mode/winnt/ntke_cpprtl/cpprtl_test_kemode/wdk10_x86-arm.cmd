...
@echo on
"%GNU_MAKE_EXE%"  target.toolset=wdk10_x86-arm  target.profile=cpprtl_debug    target.kernel=nt10.0
"%GNU_MAKE_EXE%"  target.toolset=wdk10_x86-arm  target.profile=cpprtl_release  target.kernel=nt10.0
@echo off
