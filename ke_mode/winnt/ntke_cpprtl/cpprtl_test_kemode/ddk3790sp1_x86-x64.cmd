...
@echo on
"%GNU_MAKE_EXE%"  target.toolset=ddk3790sp1_x86-x64  target.profile=cpprtl_debug    target.kernel=nt5.2
"%GNU_MAKE_EXE%"  target.toolset=ddk3790sp1_x86-x64  target.profile=cpprtl_release  target.kernel=nt5.2
@echo off
