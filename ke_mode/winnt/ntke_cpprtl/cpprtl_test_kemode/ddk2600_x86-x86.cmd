...
@echo on
"%GNU_MAKE_EXE%" target.toolset=ddk2600_x86-x86 target.profile=debug target.kernel=nt5.0
"%GNU_MAKE_EXE%" target.toolset=ddk2600_x86-x86 target.profile=release target.kernel=nt5.0
@echo off
