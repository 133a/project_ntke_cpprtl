...
@echo on
"%GNU_MAKE_EXE%" target.toolset=ddk3790sp1_x86-x86 target.profile=debug target.kernel=nt5.1
"%GNU_MAKE_EXE%" target.toolset=ddk3790sp1_x86-x86 target.profile=release target.kernel=nt5.1
@echo off
