...
set "PATH=%DDK3790SP1_FOLDER%\bin\x86;%PATH%"


@echo on
"%GNU_MAKE_EXE%"  target.toolset=ddk3790sp1_x86-x86  target.profile=cpprtl_debug    target.kernel=nt5.1
"%GNU_MAKE_EXE%"  target.toolset=ddk3790sp1_x86-x86  target.profile=cpprtl_release  target.kernel=nt5.1
@echo off
