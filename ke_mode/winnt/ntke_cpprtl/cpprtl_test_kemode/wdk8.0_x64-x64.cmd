...
@echo on
"%GNU_MAKE_EXE%"  target.toolset=wdk8.0_x64-x64  target.profile=cpprtl_debug    target.kernel=nt6.2
"%GNU_MAKE_EXE%"  target.toolset=wdk8.0_x64-x64  target.profile=cpprtl_release  target.kernel=nt6.2
@echo off
