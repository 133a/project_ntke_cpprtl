...
set "PATH=%INTELCL13.0_FOLDER%\bin\ia32_intel64;%MSVS2012_FOLDER%\VC\bin\x86_amd64;%MSVS2012_FOLDER%\Common7\IDE;%PATH%"

@echo on
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk8.0_x86-x64 target.profile=debug target.kernel=nt6.2
"%GNU_MAKE_EXE%" target.toolset=icl13.0_wdk8.0_x86-x64 target.profile=release target.kernel=nt6.2
@echo off
