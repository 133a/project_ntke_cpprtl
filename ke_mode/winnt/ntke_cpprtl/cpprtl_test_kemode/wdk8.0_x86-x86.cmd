...
@echo on
"%GNU_MAKE_EXE%" target.toolset=wdk8.0_x86-x86 target.profile=debug target.kernel=nt6.2
"%GNU_MAKE_EXE%" target.toolset=wdk8.0_x86-x86 target.profile=release target.kernel=nt6.2
@echo off
