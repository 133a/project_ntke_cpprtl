...
@echo on
"%GNU_MAKE_EXE%" target.toolset=wdk8.1_x86-arm target.profile=debug target.kernel=nt6.3
"%GNU_MAKE_EXE%" target.toolset=wdk8.1_x86-arm target.profile=release target.kernel=nt6.3
@echo off
