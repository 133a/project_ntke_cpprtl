...
@echo on
"%GNU_MAKE_EXE%" target.toolset=wdk6.1sp1_x86-x64 target.profile=debug target.kernel=nt6.0
"%GNU_MAKE_EXE%" target.toolset=wdk6.1sp1_x86-x64 target.profile=release target.kernel=nt6.0
@echo off
