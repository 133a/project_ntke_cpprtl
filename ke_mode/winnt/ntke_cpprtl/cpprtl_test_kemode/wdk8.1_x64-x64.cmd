...
set "PATH=%MSVS2013_FOLDER%\VC\bin\amd64;%PATH%"


@echo on
"%GNU_MAKE_EXE%"  target.toolset=wdk8.1_x64-x64  target.profile=cpprtl_debug    target.kernel=nt6.3
"%GNU_MAKE_EXE%"  target.toolset=wdk8.1_x64-x64  target.profile=cpprtl_release  target.kernel=nt6.3
@echo off
