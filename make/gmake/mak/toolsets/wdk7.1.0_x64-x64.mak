...
# be aware these are x86-x64 cross-compiler and linker (not a native x64)
...
wdk710.signtool       = $(wdk710.dir.bin)/amd64/SignTool.exe
wdk.signtool          = $(wdk710.signtool)


wdk710.makecert       = $(wdk710.dir.bin)/amd64/MakeCert.exe
wdk.makecert          = $(wdk710.makecert)


wdk710.certmgr        = $(wdk710.dir.bin)/amd64/CertMgr.exe
wdk.certmgr           = $(wdk710.certmgr)


wdk710.pvk2pfx        = $(wdk710.dir.bin)/amd64/pvk2pfx.exe
