...
wdk6001.compiler     = $(wdk6001.dir.bin)/x86/amd64/cl.exe
wdk.compiler         = $(wdk6001.compiler)

# Microsoft (R) Macro Assembler (x64) Version 8.00.50727.278
wdk6001.assembler    = $(wdk6001.dir.bin)/x86/amd64/ml64.exe
wdk.assembler        = $(wdk6001.assembler)

# Microsoft (R) Incremental Linker Version 8.00.50727.278
wdk6001.linker       = $(wdk6001.dir.bin)/x86/amd64/link.exe
wdk.linker           = $(wdk6001.linker)

# Microsoft (R) Incremental Linker Version 8.00.50727.278
wdk6001.libmgr       = $(wdk6001.dir.bin)/x86/amd64/link.exe
...
ifeq        '$(target.kernel)'  'nt5.2'
  wdk6001.dir.lib.kernel = wnet
else ifeq   '$(target.kernel)'  'nt6.0'
  wdk6001.dir.lib.kernel = wlh
else 
...
wdk.dir.lib.wdm       = $(wdk6001.dir.lib)/$(wdk6001.dir.lib.kernel)/amd64
wdk.dir.include.kmdf  = $(wdk6001.dir.include)/wdf/kmdf/1.7
wdk.dir.lib.kmdf      = $(wdk6001.dir.lib)/wdf/kmdf/amd64/1.7
