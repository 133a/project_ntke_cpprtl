...
wdk710.compiler       = $(wdk710.dir.bin)/x86/x86/cl.exe
wdk.compiler          = $(wdk710.compiler)

wdk710.assembler      = $(wdk710.dir.bin)/x86/ml.exe
wdk.assembler         = $(wdk710.assembler)

wdk710.linker         = $(wdk710.dir.bin)/x86/x86/link.exe
wdk.linker            = $(wdk710.linker)

wdk710.libtool        = $(wdk710.dir.bin)/x86/x86/link.exe
...
wdk.dir.lib.wdm           = $(wdk710.dir.lib)/$(wdk710.dir.lib.kernel)/i386
wdk.dir.include.kmdf      = $(wdk710.dir.include)/wdf/kmdf/1.9
wdk.dir.lib.kmdf          = $(wdk710.dir.lib)/wdf/kmdf/i386/1.9
