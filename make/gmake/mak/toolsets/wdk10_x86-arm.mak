...
msvc2015.assembler         = $(msvc2015.dir.bin)/armasm.exe
...
winsdk_10.signtool         = $(winsdk_10.dir.bin)/x86/signtool.exe
wdk.signtool               = $(winsdk_10.signtool)

winsdk_10.makecert         = $(winsdk_10.dir.bin)/x86/makecert.exe
wdk.makecert               = $(winsdk_10.makecert)

winsdk_10.certmgr          = $(winsdk_10.dir.bin)/x86/certmgr.exe
wdk.certmgr                = $(winsdk_10.certmgr)

winsdk_10.pvk2pfx          = $(winsdk_10.dir.bin)/x86/pvk2pfx.exe
...
wdk10.dir.lib              = $(winsdk_10.dir)/Lib/$(wdk10.dir.lib.kernel)/km/arm
