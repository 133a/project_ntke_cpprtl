...
msvc2012.dir.bin      = $(msvc2012.dir)/bin/amd64
...
# Microsoft (R) Macro Assembler (x64) Version 11.00.50727.1 (msvs2012u5)
...
winsdk8.0.signtool  = $(winsdk8.0.dir.bin)/x64/signtool.exe
wdk.signtool        = $(winsdk8.0.signtool)

winsdk8.0.makecert  = $(winsdk8.0.dir.bin)/x64/makecert.exe
wdk.makecert        = $(winsdk8.0.makecert)

winsdk8.0.certmgr   = $(winsdk8.0.dir.bin)/x64/certmgr.exe
wdk.certmgr         = $(winsdk8.0.certmgr)

winsdk8.0.pvk2pfx   = $(winsdk8.0.dir.bin)/x64/pvk2pfx.exe
