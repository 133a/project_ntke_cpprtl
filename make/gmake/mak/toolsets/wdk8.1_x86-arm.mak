...
msvc2013.assembler         = $(msvc2013.dir.bin)/armasm.exe
...
winsdk_8.1.signtool        = $(winsdk_8.1.dir.bin)/x86/signtool.exe
wdk.signtool               = $(winsdk_8.1.signtool)

winsdk_8.1.makecert        = $(winsdk_8.1.dir.bin)/x86/makecert.exe
wdk.makecert               = $(winsdk_8.1.makecert)

winsdk_8.1.certmgr         = $(winsdk_8.1.dir.bin)/x86/certmgr.exe
wdk.certmgr                = $(winsdk_8.1.certmgr)

winsdk_8.1.pvk2pfx         = $(winsdk_8.1.dir.bin)/x86/pvk2pfx.exe
...
wdk81.dir.lib              = $(winsdk_8.1.dir)/Lib/$(wdk81.dir.lib.kernel)/km/arm
