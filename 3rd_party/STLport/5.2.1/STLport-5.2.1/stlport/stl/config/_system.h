 ...
 */
/////////////////////////////////////////////////////////////////////////////
//  the file was modified by: copyright (c) 2012-2013 project_ntke_cpprtl
/////////////////////////////////////////////////////////////////////////////
...
#elif defined ( NT_KERNEL_MODE ) || defined ( NT_NATIVE_MODE ) || defined ( _NTU_CPPRTL_ )
#  if defined (__ICL)         /* Intel C++ compiler for Win */
...
#  endif
#  include <internal_/stlport_supp/ntke_stlport_cfg.h>
